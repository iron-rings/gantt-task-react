...
export const Gantt: React.FunctionComponent<GanttProps> = ({
  ...
  barFill = 60,
  barCornerRadius = 0,
  barProgressColor = "#3BB3E8",
  barProgressSelectedColor = "#83D004",
  barBackgroundColor = "#b8c2cc",
  barBackgroundSelectedColor = "#aeb8c2",
  projectProgressColor = "#345185",
  projectProgressSelectedColor = "#345185",
  projectBackgroundColor = "#345185",
  projectBackgroundSelectedColor = "#345185",
  milestoneBackgroundColor = "#3BB3E8",
  milestoneBackgroundSelectedColor = "#83D004",
  rtl = false,
  handleWidth = 8,
  timeStep = 300000,
  arrowColor = "grey",
  fontFamily = "'lowline-only', 'BIZ UDPGothic', 'Noto Sans JP', 'Helvetica', 'Arial', sans-serif",
  fontSize = "14px",
  arrowIndent = 20,
  ...
  const hoverWrapper = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    targetElement?.setAttribute("style", `position: absolute; top: ${ganttHeight}px; left: 550px; width: 78%;`);
    setHoverFlg(true);
  }
